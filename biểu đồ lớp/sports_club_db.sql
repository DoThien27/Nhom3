...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 05, 2026 lúc 09:07 AM
...
('EP011', 'E002', 'M003', 'Nguyễn Thùy Chi', '2024-04-10 00:00:00', 'PENDING'),
('EP012', 'E002', 'M005', 'Đỗ Thị Hoa', '2024-04-11 00:00:00', 'APPROVED'),
('EP013', 'E002', 'M009', 'Phạm Lan Anh', '2024-04-12 00:00:00', 'PENDING');
...
('U005', 'le_thu', '$2b$12$gBPVodMJ/P9hhKheUMn1jOYfUKFzzEID95cIKzpI6sqSxAFZdc0ri', 'Lê Thị Thu', 'RECEPTIONIST', 'Lễ tân', 0, NULL);
